...
import javafx.scene.control.PasswordField;
	...
	public class JoinController implements Initializable {
		...
		public void handlerBtnJoinActoion(ActionEvent event) {
			...
			if (txtPasswd.getText().trim().equals(txtPasswdRepeat.getText().trim())&& !txtName.getText().trim().equals("")) {
				jvo = new JoinVO(txtId.getText().trim(), txtPasswd.getText().trim(), txtName.getText().trim(), txtPhone.getText().trim(), txtBank.getText().trim(), txtAccount.getText().trim());
				jdao = new JoinDAO();
