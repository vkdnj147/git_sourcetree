...
public class TotalEmployeeTabController implements Initializable {
	...
	static ObservableList<EmployeeVO> employeeDataList = FXCollections.observableArrayList();// 직원 정보를 저장
	...
	// 직원 전체 목록
	public static void employeeTotalList() throws Exception {//앞에는 소문자~!
